...
const static_page_repository_1 = require("./repositories/static-page.repository");
...
exports.StaticPagesModule = StaticPagesModule = __decorate([
    (0, common_1.Module)({
        providers: [static_pages_service_1.StaticPagesService, static_page_repository_1.StaticPageRepository, prisma_service_1.PrismaService],
